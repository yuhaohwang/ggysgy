...
var t = e(require('crypto')),
  ...
  i = e(require('util'))
const o = {
    PARAM_ERROR: { errCode: 'param-error' },
    PARAM_REQUIRED: { errCode: 'param-required' },
    USER_NOT_EXIST: { errCode: 'user-not-exist' },
    ROLE_NOT_EXIST: { errCode: 'role-not-exist' },
    PERMISSION_NOT_EXIST: { errCode: 'permission-not-exist' },
    MULTI_USER_MATCHED: { errCode: 'multi-user-matched' },
    USER_INFO_ERROR: { errCode: 'user-info-error' },
    USER_ACCOUNT_CONFLICT: { errCode: 'user-account-conflict' },
    USER_ACCOUNT_CLOSED: { errCode: 'user-account-closed' },
    ACCOUNT_ALREADY_REGISTED: { errCode: 'account-already-registed' },
    ACCOUNT_NOT_REGISTED: { errCode: 'account-not-registed' },
    ACCOUNT_already_BOUND: { errCode: 'account-already-bound' },
    UNBIND_FAILED: { errCode: 'unbind-failed' },
    INVALID_INVITE_CODE: { errCode: 'invalid-invite-code' },
    SET_INVITE_CODE_FAILED: { errCode: 'set-invite-code-failed' },
    GET_THIRD_PARTY_ACCOUNT_FAILED: { errCode: 'get-third-party-account-failed' },
  },
  s = {
    0: { errCode: 0, errMsg: '' },
    10001: { errCode: 'account-banned' },
    ...
    10102: { errCode: 'password-error' },
    10103: { errCode: 'password-error-exceed-limit' },
    ...
    30201: { errCode: 'check-device-feature-failed' },
    30202: { errCode: 'token-not-exist' },
    30203: { errCode: 'token-expired' },
    30204: { errCode: 'check-token-failed' },
    40201: o.USER_NOT_EXIST,
    40202: { errCode: 'invalid-old-password' },
    50101: o.PARAM_REQUIRED,
    50102: o.PARAM_ERROR,
    50201: o.PARAM_REQUIRED,
    50203: o.PARAM_ERROR,
    50202: { errCode: 'invalid-verify-code' },
    50301: { errCode: 'send-sms-code-failed' },
    ...
    80503: { errCode: 'modify-invite-code-is-not-allowed' },
    ...
    80801: { errCode: 'decrypt-weixin-data-failed' },
    80802: { errCode: 'decrypt-weixin-data-failed' },
    80803: { errCode: 'invalid-weixin-appid' },
    80804: o.PARAM_REQUIRED,
    80805: o.PARAM_REQUIRED,
    80806: o.PARAM_REQUIRED,
    90001: { errCode: 'database-operation-failed' },
...
function v(e, t) {
  ...
  for (const i in e)
    if (d(e, i) && r.test(i)) {
      ...
      ;(e[r] = e[i]),
        delete e[i],
        l(e[r]) ? (e[r] = v(e[r], t)) : Array.isArray(e[r]) && (e[r] = e[r].map((e) => v(e, t)))
    }
  return e
}
function _(e) {
...
function x(e = {}, t) {
  ...
  if (l(t))
    for (const i in t) {
      ...
      p(o) && -1 === r.indexOf(i)
        ? (e[i] = o(e))
        : 'string' == typeof o && -1 === r.indexOf(i) && ((e[i] = e[o]), n.shouldDelete.add(o))
    }
  else p(t) && (e = t(e))
  ...
  if (l(e))
    if (0 === e.code) (e.errCode = e.code), (e.message = e.errMsg = e.msg), delete e.messageValues
      ...
      ;(e.errCode = 'uni-id-' + t.errCode),
        (e.errMsg = this.t(t.errCode, e.messageValues || {}) || e.msg),
...
var O = {
  ...
  en: {
    ...
    'login-with-invite-type-required':
      'parameter type is required when forceInviteCode set to true',
    ...
    'config-file-invalid':
      'invalid config file (common/uni-config-center/uni-id/config.json), please note that comment is not allowed',
    ...
    'context-required':
      'context.{key} is required, you should pass context using uniID.createInstance',
  },
}
const k = uniCloud.database(),
  ...
  B = 1,
  F = 4
async function $({ uid: e, status: t } = {}) {
  return e
    ? (await j.doc(e).update({ status: t, status_update_date: Date.now() }), { code: 0 })
    : { code: N, messageValues: { param: this.t('user-id') } }
}
async function H({ name: e, url: t, data: r, options: n, defaultOptions: i }) {
  let o = {}
  ...
  try {
    ...
    return (function (e, t) {
      throw new a({ code: t.code || -2, message: t.message || e + ' fail' })
    })(e, t)
  }
  let c = o.data
  const u = o.headers['content-type']
  if (!Buffer.isBuffer(c) || (0 !== u.indexOf('text/plain') && 0 !== u.indexOf('application/json')))
    Buffer.isBuffer(c) && (c = { buffer: c, contentType: u })
  else
    try {
  ...
  return _(
    (function (e, t) {
      if (t.errcode) throw new a({ code: t.errcode || -2, message: t.errmsg || e + ' fail' })
      return delete t.errcode, delete t.errmsg, { ...t, errMsg: e + ' ok', errCode: 0 }
    })(e, c || { errCode: -2, errMsg: 'Request failed' })
  )
}
function K(e, t) {
  let r = ''
...
async function z({ name: e, url: t, data: r, options: n, defaultOptions: i }) {
  let o
  n = Object.assign({}, i, n, { data: b(Object.assign({}, r)) })
  try {
  ...
  if (!Buffer.isBuffer(s) || (0 !== c.indexOf('text/plain') && 0 !== c.indexOf('application/json')))
    Buffer.isBuffer(s) && (s = { buffer: s, contentType: c })
  else
    try {
...
class Q {
  ...
  async getOpenidByToken({ accessToken: e } = {}) {
    const t = await this._requestQQOpenapi({
      ...
      url: '/oauth2.0/me',
      data: { accessToken: e, unionid: 1, fmt: 'json' },
    })
    if (t.clientId !== this.options.appId)
      throw new a({ code: 'APPID_NOT_MATCH', message: 'appid not match' })
...
const Y = { RSA: 'RSA-SHA1', RSA2: 'RSA-SHA256' }
var X = { code2Session: { returnValue: { openid: 'userId' } } }
  ...
  _getSign(e, r) {
    ...
    const i = Object.assign(
      {
        ...
        timestamp: E(
          ((o = this.options.timeOffset),
          new Date(Date.now() + 6e4 * (new Date().getTimezoneOffset() + 60 * (o || 0))))
        ),
      },
      r
    )
    ...
    const s = b(i),
      a = Object.keys(s)
        ...
        .join('&'),
      c = t
        .createSign(Y[this.options.signType])
        .update(a, 'utf8')
    ...
    if (d) {
      if (!r.validateSign || this._checkResponseSign(a, u)) {
        if (!d.code || '10000' === d.code) {
          return { errCode: 0, errMsg: d.msg || '', ..._(d) }
        }
...
function oe(e) {
  if (((this.buffer = null), (this.writable = !0), (this.readable = !0), !e))
    return (this.buffer = ie.alloc(0)), this
...
var he = { ES256: fe(256), ES384: fe(384), ES512: fe(521) }
var me = function (e) {
    var t = he[e]
    if (t) return t
...
var ve = {
    derToJose: function (e, t) {
      ...
      var s = e[o++]
      if ((129 === s && (s = e[o++]), i - o < s))
        throw new Error('"seq" specified length of "' + s + '", only "' + (i - o) + '" remaining')
      if (2 !== e[o++]) throw new Error('Could not find expected "int" for "r"')
      var a = e[o++]
      if (i - o - 2 < a)
        throw new Error('"r" specified length of "' + a + '", only "' + (i - o - 2) + '" available')
      if (n < a)
        throw new Error('"r" specified length of "' + a + '", max of "' + n + '" is acceptable')
      var c = o
      ...
      var d = o
      if ((o += u) !== i)
        throw new Error('Expected to consume entire buffer, but "' + (i - o) + '" bytes remain')
      var l = r - a,
        p = r - u,
      ...
      return (
        e.copy(f, o, d + Math.max(-p, 0), d + u),
        (f = (f = f.toString('base64')).replace(/=/g, '').replace(/\+/g, '-').replace(/\//g, '_'))
      )
    },
    joseToDer: function (e, t) {
      ...
      var r = me(t),
        n = e.length
      if (n !== 2 * r)
        throw new TypeError('"' + t + '" signatures must be "' + 2 * r + '" bytes, saw "' + n + '"')
      var i = we(e, 0, r),
        o = we(e, r, e.length),
        s = r - i,
        a = r - o,
...
function Ae(e) {
  if (!_e.isBuffer(e) && 'string' != typeof e && 'object' != typeof e)
    throw Ie('key must be a string, a buffer or an object')
}
function xe(e) {
...
var Me = function (e) {
    var t = { hs: ke, rs: Re, ps: De, es: Ne, none: Ue },
      r = { hs: je, rs: Pe, ps: qe, es: Le, none: Ve },
...
function tt(e, t) {
  ...
  return (
    ...
    { header: r, payload: n, signature: We(e) }
  )
}
function rt(e) {
...
var wt = function (e, t) {
  ...
  vt = re(function (e, t) {
    ...
    function K(e, t) {
      if (
        ((t && 'object' == typeof t) || (t = { loose: !!t, includePrerelease: !1 }), e instanceof G)
      )
        return e
        ...
        if (
          (d.forEach(function (e) {
            e.semver === ie && (e = new ne('>=0.0.0')),
              (l = l || e),
              (p = p || e),
              i(e.semver, l.semver, n) ? (l = e) : s(e.semver, p.semver, n) && (p = e)
          }),
    ...
    ;(ne.prototype.parse = function (e) {
      ...
      ;(this.operator = r[1]),
        ...
        r[2] ? (this.semver = new G(r[2], this.options.loose)) : (this.semver = ie)
    }),
      ...
      (oe.prototype.parseRange = function (e) {
        ...
        ;(e = e.replace(n, ae)),
          r('hyphen replace', e),
          (e = e.replace(i[M], '$1$2$3')),
          r('comparator trim', e, i[M]),
          (e = (e = (e = e.replace(i[j], '$1~')).replace(i[q], '$1^')).split(/\s+/).join(' '))
        var o = t ? i[U] : i[V],
          s = e
            .split(' ')
            .map(function (e) {
  ...
  _t =
    ...
    vt.inc,
    vt.diff,
    vt.compareIdentifiers,
    vt.rcompareIdentifiers,
    vt.major,
    vt.minor,
    vt.patch,
    vt.compare,
    ...
    vt.intersects,
    vt.coerce,
    vt.satisfies(process.version, '^6.12.0 || >=8.0.0')),
  ...
  var r =
      ...
      (function (e) {
        return (
          ...
          qt.call(e, 'callee') &&
          (!Lt.call(e, 'callee') || '[object Arguments]' == Nt.call(e))
        )
      })(e)
        ? (function (e, t) {
...
function Bt(e) {
  if (
    ((r = (t = e) && t.constructor), (n = ('function' == typeof r && r.prototype) || Dt), t !== n)
  )
    return Ut(e)
  var t,
    r,
...
var Sr = {
    ...
    header: { isValid: fr, message: '"header" must be an object' },
    encoding: { isValid: gr, message: '"encoding" must be a string' },
    issuer: { isValid: gr, message: '"issuer" must be a string' },
    subject: { isValid: gr, message: '"subject" must be a string' },
    jwtid: { isValid: gr, message: '"jwtid" must be a string' },
    noTimestamp: { isValid: Yt, message: '"noTimestamp" must be a boolean' },
    keyid: { isValid: gr, message: '"keyid" must be a string' },
    mutatePayload: { isValid: Yt, message: '"mutatePayload" must be a boolean' },
  },
  Ir = {
    iat: { isValid: or, message: '"iat" should be a number of seconds' },
    exp: { isValid: or, message: '"exp" should be a number of seconds' },
    nbf: { isValid: or, message: '"nbf" should be a number of seconds' },
  }
function Or(e, t, r, n) {
...
var kr = { audience: 'aud', issuer: 'iss', subject: 'sub', jwtid: 'jti' },
  ...
  Rr = function (e, t, r, n) {
    ...
    if (
      ...
      return i(new at('clockTimestamp must be a number'))
    if (void 0 !== r.nonce && ('string' != typeof r.nonce || '' === r.nonce.trim()))
      return i(new at('nonce must be a non-empty string'))
    ...
    return c(u, function (t, n) {
      ...
      if (
        ...
        return i(new at('invalid algorithm'))
      try {
      ...
      if (void 0 !== l.nbf && !r.ignoreNotBefore) {
        ...
        if (l.nbf > o + (r.clockTolerance || 0))
          return i(new ut('jwt not active', new Date(1e3 * l.nbf)))
      }
      if (void 0 !== l.exp && !r.ignoreExpiration) {
        if ('number' != typeof l.exp) return i(new at('invalid exp value'))
        if (o >= l.exp + (r.clockTolerance || 0))
          return i(new lt('jwt expired', new Date(1e3 * l.exp)))
      }
      if (r.audience) {
      ...
      if (
        r.issuer &&
        (('string' == typeof r.issuer && l.iss !== r.issuer) ||
          (Array.isArray(r.issuer) && -1 === r.issuer.indexOf(l.iss)))
      )
        return i(new at('jwt issuer invalid. expected: ' + r.issuer))
      if (r.subject && l.sub !== r.subject)
        return i(new at('jwt subject invalid. expected: ' + r.subject))
      if (r.jwtid && l.jti !== r.jwtid) return i(new at('jwt jwtid invalid. expected: ' + r.jwtid))
      if (r.nonce && l.nonce !== r.nonce)
        return i(new at('jwt nonce invalid. expected: ' + r.nonce))
      if (r.maxAge) {
      ...
      if (!0 === r.complete) {
        var h = s.signature
        return i(null, { header: u, payload: l, signature: h })
      }
      return i(null, l)
    })
  },
  Pr = function (e, t, r, n) {
    ...
    var i = 'object' == typeof e && !Buffer.isBuffer(e),
      o = Object.assign(
        { alg: r.algorithm || 'HS256', typ: i ? 'JWT' : void 0, kid: r.keyid },
        r.header
      )
    function s(e) {
      if (n) return n(e)
    ...
    if (i) {
      ...
      if (a.length > 0)
        return s(new Error('invalid ' + a.join(',') + ' option for ' + typeof e + ' payload'))
    }
    ...
    Object.keys(kr).forEach(function (t) {
      ...
      if (void 0 !== r[t]) {
        if (void 0 !== e[n])
          return s(
            new Error(
              'Bad "options.' + t + '" option. The payload already has an "' + n + '" property.'
            )
          )
        e[n] = r[t]
      }
    ...
    if ('function' != typeof n) return it.sign({ header: o, payload: e, secret: t, encoding: u })
    ;(n = n && Ar(n)),
      it
...
class qr {
  constructor(e) {
    this.options = Object.assign({ baseUrl: 'https://appleid.apple.com', timeout: 1e4 }, e)
  }
  async _fetch(e, t) {
  ...
  async verifyIdentityToken(e) {
    const t = e.split('.')[0],
      { kid: r } = JSON.parse(Buffer.from(t, 'base64').toString())
    if (!Dr.length)
      try {
        Dr = await this.getAuthKeys()
      } catch (e) {
        return { code: 10705, msg: e.message }
      }
...
const Br = k.command
async function Fr({ uid: e, dcloudAppidList: t } = {}) {
  if (!e) return { code: N, messageValues: { param: this.t('user-id') } }
  if (!t || 0 === t.length || t.some((e) => void 0 === e))
    return { code: N, messageValues: { param: this.t('dcloud-appid') } }
  ...
  let o
  const s = { dcloud_appid: Br.in(t), _id: Br.neq(n._id) },
    a = { dcloud_appid: Br.exists(!1), _id: Br.neq(n._id) }
  switch (i.length) {
    case 0:
      return { code: 10004 }
    case 1:
  ...
  return c && c.data && c.data[0] ? { code: 10005 } : { code: 0 }
}
...
async function zr(e) {
  ...
  for (let r = 0, n = t.length; r < n; r++) {
    const n = t[r]
    if (!e[n]) throw new Error(this.t('config-param-requred', { param: 'service.univerify.' + n }))
  }
  if (!e.openid || !e.access_token)
    throw new Error(this.t('config-param-requred', { param: 'openid, access_token' }))
  return (function (e, t) {
    const r = {
      0: '',
      4e3: '缺失参数',
    ...
    return { ...e, msg: r[e.code] ? '[getPhoneNumber] 获取手机号: ' + r[e.code] : e.errMsg }
...
var cn = Object.freeze({
    ...
    getUserInfo: async function ({ uid: e, field: t }) {
      ...
      return 0 === r.data.length ? { code: 80301 } : { code: 0, msg: '', userInfo: r.data[0] }
    },
    ...
    resetPwd: async function ({ uid: e, password: t }) {
      ...
      return (
        ...
        C('upRes', await j.doc(e).update(i)),
        { code: 0, msg: '' }
      )
    },
    setAvatar: async function (e) {
      return await j.doc(e.uid).update({ avatar: e.avatar }), { code: 0, msg: '' }
    },
      ...
      if (t && t.data && t.data.length > 0) {
        if (0 === this._checkPwd(t.data[0], e.oldPassword).code) {
          const { passwordHash: r, version: n } = this.encryptPwd(e.newPassword),
            i = { password: r, token: [] }
          n && (i.password_secret_version = n)
          return C('upRes', await j.doc(t.data[0]._id).update(i)), { code: 0, msg: '' }
        }
        return { code: 40202 }
      }
      return { code: 40201 }
    ...
    updateUser: async function (e) {
      const t = e.uid
      if (!t) return { code: N, messageValues: { param: this.t('user-id') } }
      delete e.uid
      ...
      return (
        ...
        C('update -> upRes', await j.doc(t).update(e)),
        { code: 0, msg: '' }
      )
    },
    banAccount: async function ({ uid: e } = {}) {
      return $.call(this, { uid: e, status: B })
    },
    unbanAccount: async function ({ uid: e } = {}) {
      return $.call(this, { uid: e, status: M })
    },
    closeAccount: async function ({ uid: e } = {}) {
      return $.call(this, { uid: e, status: F })
    },
    openAccount: async function ({ uid: e } = {}) {
      return $.call(this, { uid: e, status: M })
    },
    _getAlipayApi: function () {
      ...
      if (!t.oauth || !t.oauth.alipay)
        throw new Error(this.t('config-param-require', { param: e + '.alipay' }))
      return (
        ['appid', 'privateKey'].forEach((r) => {
          if (!t.oauth.alipay[r])
            throw new Error(this.t('config-param-require', { param: `${e}.alipay.${r}` }))
        }),
        Ur({ ...t.oauth.alipay })
      )
    },
    _getValidInviteCode: async function ({ inviteCode: e }) {
      ...
      try {
        for (; r > 0 && !n; ) {
          r--
          if (0 === (await j.where({ my_invite_code: t }).get()).data.length) {
            n = !0
            break
          }
          t = Mr()
      ...
      return n ? { code: 0, inviteCode: t } : e ? { code: 80401 } : { code: 80402 }
    },
    _addUser: async function (e, { needPermission: t, autoSetDcloudAppid: r = !0 } = {}) {
      const n = this._getConfig(),
        ...
        o = (await j.add(i)).id
      let s
      if (n.removePermissionAndRoleFromToken)
        s = await this.createToken({ uid: o, needPermission: t })
      else {
        const t = e.role || []
        let r
        ;(r =
          0 === t.length || t.includes('admin') ? [] : await this._getPermissionListByRoleList(t)),
          (s = await this.createToken({ uid: o, role: t, permission: r }))
      }
      const { token: a, tokenExpired: c } = s
      return (
        await j.doc(o).update({ token: [a] }),
        {
          token: a,
          tokenExpired: c,
          uid: o,
          type: 'register',
          userInfo: Object.assign({}, i, { token: a }),
        }
      )
    },
    _loginExec: async function (e, t = {}) {
      if (e.status === B) return { code: 10001 }
      if (e.status === F) return { code: 10006 }
    ...
    _registerExec: async function (e, { needPermission: t, autoSetDcloudAppid: r = !0 } = {}) {
      ...
      return {
        code: 0,
        msg: '',
        ...(await this._addUser(e, { needPermission: t, autoSetDcloudAppid: r })),
      }
    },
    _getWeixinApi: function ({ platform: e } = {}) {
      const t = this.context.PLATFORM,
        r = this._getConfig()
      if (!r.oauth || !r.oauth.weixin)
        throw new Error(this.t('config-param-require', { param: t + '.weixin' }))
      return (
        ['appid', 'appsecret'].forEach((e) => {
          if (!r.oauth.weixin[e])
            throw new Error(this.t('config-param-require', { param: `${t}.weixin.${e}` }))
        }),
        Nr({ ...r.oauth.weixin })
      )
    },
    _getQQApi: function () {
      const e = this.context.PLATFORM,
        t = this._getConfig()
      if (!t.oauth || !t.oauth.qq)
        throw new Error(this.t('config-param-require', { param: e + '.qq' }))
      return (
        ['appid', 'appsecret'].forEach((r) => {
          if (!t.oauth.qq[r])
            throw new Error(this.t('config-param-require', { param: `${e}.qq.${r}` }))
        }),
        Lr({ ...t.oauth.qq })
      )
    },
    _getMatchedUser: function (e, t) {
      ...
      for (let r = e.length - 1; r >= 0; r--) {
        ...
        for (let s = 0; s < t.length; s++) {
          ...
          c && o[a] === c
            ? ((n[a] = o), e.splice(r, 1))
            : u && o[a] === u && (n[a] || (n[a] = o), (i[a] = !0), e.splice(r, 1))
        }
      }
    ...
    _getCurrentAppUser: function (e) {
      ...
      return e.filter(
        (e) =>
          void 0 === e.dcloud_appid ||
          null === e.dcloud_appid ||
          e.dcloud_appid.indexOf(t) > -1 ||
          e.dcloud_appid.indexOf(null) > -1
      )
    },
    _checkLoginUserList: function (e) {
      if (e && 1 !== e.length) return e[0].status === F ? { code: 10006 } : { code: 10005 }
    },
      ...
      if ('array' !== h(t))
        return {
          ...
          messageValues: {
            ...
            reason: this.t('type-array-required', { param: this.t('dcloud-appid-list') }),
          },
        }
      if (t && 0 !== t.length) {
        const r = await Fr.bind(this)({ uid: e, dcloudAppidList: t })
        if (r.code) return r
      }
      return await j.doc(e).update({ dcloud_appid: Br.set(t) }), { code: 0 }
    },
    authorizeAppLogin: async function ({ uid: e, dcloudAppid: t } = {}) {
      const r = await Fr.bind(this)({ uid: e, dcloudAppidList: [t] })
      return r.code ? r : (await j.doc(e).update({ dcloud_appid: Br.push(t) }), { code: 0 })
    },
    forbidAppLogin: async function ({ uid: e, dcloudAppid: t } = {}) {
      return e
        ? (await j.doc(e).update({ dcloud_appid: Br.pull(t) }), { code: 0 })
        : { code: N, messageValues: { param: this.t('user-id') } }
    },
    acceptInvite: async function ({ uid: e, inviteCode: t }) {
      const r = await j
        .where({ _id: $r.neq(e), inviter_uid: $r.not($r.all([e])), my_invite_code: t })
        .get()
      if (1 !== r.data.length) return { code: 80501, msg: '邀请码无效' }
      const n = [r.data[0]._id].concat(r.data[0].inviter_uid || []),
        i = await j.doc(e).field({ my_invite_code: !0, inviter_uid: !0 }).get()
      if (0 === i.data.length) return { code: 80502 }
      if (i.data[0].inviter_uid && i.data[0].inviter_uid.length > 0)
        return { code: 80503, msg: '邀请码不可修改' }
      const o = Date.now()
      return (
        await j.doc(e).update({ inviter_uid: n, invite_time: o }),
        await j.where({ inviter_uid: e }).update({ inviter_uid: $r.push(n) }),
        { code: 0, msg: '' }
      )
    },
    ...
    setUserInviteCode: async function ({ uid: e, myInviteCode: t }) {
      ...
      return r.code
        ...
        : (await j.doc(e).update({ my_invite_code: r.inviteCode }),
          { code: 0, msg: '', myInviteCode: r.inviteCode })
    },
    loginByAlipay: async function (e) {
      'string' == typeof e && (e = { code: e })
      const { needPermission: t, code: r, myInviteCode: n, role: i, type: o } = e,
        { openid: s } = await this._getAlipayApi().code2Session(r)
      if (!s) return { code: 10501, messageValues: { account: this.t('alipay-account') } }
      let a = await j.where({ ali_openid: s }).get()
      if (((a = this._getCurrentAppUser(a.data)), a && a.length > 0)) {
        if ('register' === o)
          return { code: 10502, messageValues: { type: this.t('alipay-account') } }
        if (1 !== a.length) return { code: 10005 }
        const e = a[0],
      ...
      {
        if ('login' === o) return { code: 10503, messageValues: { type: this.t('alipay-account') } }
        const e = { ali_openid: s }
        ;(e.my_invite_code = n), (e.role = i)
        const r = await this._registerExec(e, { needPermission: t })
        return 0 !== r.code ? r : { ...r, openid: s, mobileConfirmed: !1, emailConfirmed: !1 }
      }
    },
    loginByEmail: async function ({
      ...
      if (!(e = e && e.trim())) return { code: N, messageValues: { param: '邮箱' } }
    ...
    loginBySms: async function ({
      ...
      if (!(e = e && e.trim())) return { code: N, messageValues: { param: this.t('mobile') } }
      ...
      if (((l = this._getCurrentAppUser(l.data)), l && l.length > 0)) {
        if ('register' === o) return { code: 10201, messageValues: { type: this.t('mobile') } }
        if (1 !== l.length) return { code: 10005 }
        const t = l[0],
      ...
      {
        const t = Date.now()
        if ('login' === o) return { code: 10202, messageValues: { type: this.t('mobile') } }
        const u = {
            mobile: e,
            mobile_confirmed: 1,
            register_ip: this.context.CLIENTIP,
        ...
        if (n) {
          ...
          if (1 !== e.data.length) return { code: 10203 }
          ;(u.inviter_uid = [e.data[0]._id].concat(e.data[0].inviter_uid || [])),
            (u.invite_time = t)
        } else if (c.forceInviteCode) return { code: 10203 }
    ...
    loginByWeixin: async function (e) {
      ...
      let m
      m = c ? { sessionKey: l } : { accessToken: p, refreshToken: f, accessTokenExpired: h }
      const g = Kr.command,
        y = [{ wx_openid: { [a]: u } }]
      ...
      if (((w = this._getCurrentAppUser(w.data)), w && w.length > 0)) {
        if ('register' === s)
          return { code: 10402, messageValues: { type: this.t('wechat-account') } }
        if (1 !== w.length) return { code: 10005 }
        const e = w[0],
          r = { wx_openid: { [a]: u } }
        d && (r.wx_unionid = d)
      ...
      {
        if ('login' === s) return { code: 10403, messageValues: { type: this.t('wechat-account') } }
        const e = { wx_openid: { [a]: u }, wx_unionid: d }
        ;(e.my_invite_code = i), (e.role = o)
        const r = await this._registerExec(e, { needPermission: t })
        return 0 !== r.code
          ? r
          : { ...r, openid: u, unionid: d, ...m, mobileConfirmed: !1, emailConfirmed: !1 }
      }
    },
    loginByQQ: async function ({
      ...
      if (((h = this._getCurrentAppUser(h.data)), h && h.length > 0)) {
        if ('register' === o) return { code: 10802, messageValues: { type: this.t('qq-account') } }
        if (1 !== h.length) return { code: 10005 }
        const e = h[0],
          t = { qq_openid: { [s]: c } }
        u && (t.qq_unionid = u)
      ...
      {
        if ('login' === o) return { code: 10803, messageValues: { type: this.t('qq-account') } }
        const e = { qq_openid: { [s]: c }, qq_unionid: u }
        ;(e.my_invite_code = r), (e.role = i)
        const t = await this._registerExec(e)
        return 0 !== t.code
          ? t
          : { ...t, openid: c, unionid: u, ...l, mobileConfirmed: !1, emailConfirmed: !1 }
      }
    },
    loginByUniverify: async function ({
      ...
      if (c.forceInviteCode && !o) throw new Error(this.t('login-with-invite-type-required'))
      const d = await zr.bind(this)({ ...u, openid: e, access_token: t })
      if (0 !== d.code) return d
      const l = String(d.phoneNumber)
      let p = await j.where({ mobile: l, mobile_confirmed: 1 }).get()
      if (((p = this._getCurrentAppUser(p.data)), p && p.length > 0)) {
        if ('register' === o) return { code: 10601, messageValues: { type: this.t('mobile') } }
        if (1 !== p.length) return { code: 10005 }
        const e = p[0],
          t = await this._loginExec(e, { needPermission: s })
        return 0 !== t.code ? t : { ...t, mobile: l }
      }
      if ('login' === o) return { code: 10602, messageValues: { type: this.t('mobile') } }
      const f = Date.now(),
        h = { mobile: l, my_invite_code: i, mobile_confirmed: 1, role: a },
        m = r && r.trim()
      if (m) {
        const { passwordHash: e, version: t } = this.encryptPwd(m)
        ;(h.password = e), t && (h.password_secret_version = t)
      }
      if (n) {
        let e = await j.where({ my_invite_code: n }).get()
        if (1 !== e.data.length) return { code: 10203 }
        ;(e = e.data[0]), (h.inviter_uid = [e._id].concat(e.inviter_uid || [])), (h.invite_time = f)
      } else if (c.forceInviteCode) return { code: 10203 }
      h.my_invite_code = i
      const g = await this._registerExec(h, { needPermission: s })
    ...
    loginByApple: async function ({
      ...
      if (!d)
        throw new Error(
          this.t('config-param-require', { param: '(app || app-plus).apple.bundleId' })
        )
      if (!r) return { code: N, messageValues: { param: 'identityToken' } }
      t = e || (t && Object.keys(t).length > 0 ? t.familyName + t.givenName : '')
      const { code: l, msg: p } = await Vr().verifyIdentityToken(r)
      if (0 !== l) return { code: l, msg: p, messageValues: { account: this.t('apple-account') } }
      const { iss: f, sub: h, aud: m, email: g } = p
      if ('https://appleid.apple.com' !== f)
        return { code: 10706, messageValues: { account: this.t('apple-account') } }
      if (!h) return { code: 10701, messageValues: { account: this.t('apple-account') } }
      if (d !== m) return { code: 10702, messageValues: { account: this.t('apple-account') } }
      const y = t || 'User-' + (g ? g.split('@')[0] : Math.random().toString(32).slice(2))
      let w = await j.where({ apple_openid: h }).get()
      if (((w = this._getCurrentAppUser(w.data)), w && w.length > 0)) {
        if ('register' === i)
          return { code: 10703, messageValues: { type: this.t('apple-account') } }
        if (1 !== w.length) return { code: 10005 }
        const e = w[0],
          t = await this._loginExec(e, { needPermission: o })
        return 0 !== t.code ? t : { ...t, openid: h }
      }
      if ('login' === i) return { code: 10704, messageValues: { type: this.t('apple-account') } }
      const v = { nickname: y, apple_openid: h, my_invite_code: n, role: a },
        _ = await this._registerExec(v, { needPermission: o })
      return 0 !== _.code ? _ : { ..._, openid: h }
    },
    login: async function ({ username: e, password: t, queryField: r = [], needPermission: n }) {
      const i = Qr.command,
        o = []
      ;(r && r.length) || (r = ['username']),
        r.length > 1 && console.warn(this.t('query-field-warning'))
      const {
        ...
        l = {},
        p = e && e.trim()
      if (!p) return { code: N, messageValues: { param: this.t('username') } }
      ...
      r.forEach((t) => {
        ...
        'username' === t && l.username !== e
          ...
          : 'email' === t &&
            l.email !== e &&
            (o.push({ [t]: l.email, ...d[t] }), (r.fallbackValue = l.email)),
          f.push(r)
      })
      ...
      if (v && v.error_times >= c) return { code: 10103 }
      const _ = t && t.trim()
      if (!_) return { code: N, messageValues: { param: '密码' } }
      ...
      return (
        v
          ...
          : ((v = { ip: m, error_times: 1, last_error_time: Date.now() }), w.push(v)),
        await j.doc(y._id).update({ login_ip_limit: w }),
        { code: 10102, msg: '密码错误' }
      )
    },
    register: async function (e) {
      const t = [],
        r = [
          { name: 'username', desc: this.t('username') },
          { name: 'email', desc: this.t('email'), extraCond: { email_confirmed: 1 } },
          { name: 'mobile', desc: this.t('mobile'), extraCond: { mobile_confirmed: 1 } },
        ],
      ...
      if (
        ('needPermission' in e && delete e.needPermission,
        'autoSetDcloudAppid' in e && delete e.autoSetDcloudAppid,
        0 === t.length)
      )
        return { code: 20101, messageValues: { param: this.t('user-unique-param') } }
      const l = Yr.command
      let p = await j.where(l.or(...t)).get()
      if (((p = this._getCurrentAppUser(p.data)), p && p.length > 0)) {
        const t = p[0]
        if (t.status === F) return { code: 10006 }
        for (let n = 0; n < r.length; n++) {
          const i = r[n]
          let o = !0
          if (
            (i.extraCond && (o = Object.keys(i.extraCond).every((e) => t[e] === i.extraCond[e])),
            t[i.name] === e[i.name] && o)
          )
      ...
      if (!f) return { code: N, messageValues: { param: this.t('password') } }
      const { passwordHash: h, version: m } = this.encryptPwd(f)
      ;(e.password = h),
        m && (e.password_secret_version = m),
        (e.my_invite_code = c),
        delete e.myInviteCode
    ...
    logout: async function (e) {
      ...
      if (t.code) return t
      const r = Xr.command
      return await j.doc(t.uid).update({ token: r.pull(e) }), { code: 0, msg: '' }
    },
    getRoleByUid: async function ({ uid: e }) {
      if (!e) return { code: N, messageValues: { param: this.t('user-id') } }
      const t = await j.doc(e).get()
      return 0 === t.data.length ? { code: U } : { code: 0, msg: '', role: t.data[0].role || [] }
    },
    getPermissionByRole: async function ({ roleID: e }) {
      if (!e) return { code: N, messageValues: { param: 'roleID' } }
      if ('admin' === e) {
        return {
          code: 0,
          msg: '',
      ...
      const t = await P.where({ role_id: e }).get()
      return 0 === t.data.length
        ? { code: V }
        : { code: 0, msg: '', permission: t.data[0].permission || [] }
    },
    ...
    bindRole: async function ({ uid: e, roleList: t, reset: r = !1 }) {
      ...
      return (
        'string' == typeof t && (t = [t]),
        (n.role = r ? t : Jr.push(t)),
        await j.doc(e).update(n),
        { code: 0, msg: '' }
      )
    },
    bindPermission: async function ({ roleID: e, permissionList: t, reset: r = !1 }) {
      ...
      return (
        'string' == typeof t && (t = [t]),
        (n.permission = r ? t : Jr.push(t)),
        await P.where({ role_id: e }).update(n),
        { code: 0, msg: '' }
      )
    },
    unbindRole: async function ({ uid: e, roleList: t }) {
      return (
        'string' == typeof t && (t = [t]),
        await j.doc(e).update({ role: Jr.pull(Jr.in(t)) }),
        { code: 0, msg: '' }
      )
    },
    unbindPermission: async function ({ roleID: e, permissionList: t }) {
      return (
        'string' == typeof t && (t = [t]),
        await P.where({ role_id: e }).update({ permission: Jr.pull(Jr.in(t)) }),
        { code: 0, msg: '' }
      )
    },
    addRole: async function ({ roleID: e, roleName: t, comment: r, permission: n = [] }) {
      return e
        ? 'admin' === e
          ? {
              code: L,
              messageValues: { param: 'roleID', reason: this.t('add-role-admin-is-not-allowed') },
            }
          : (await P.add({
              role_id: e,
              role_name: t,
            ...
            { code: 0, msg: '' })
        : { code: N, messageValues: { param: this.t('role-id') } }
    },
    addPermission: async function ({ permissionID: e, permissionName: t, comment: r }) {
      return e
        ? (await D.add({
          ...
          { code: 0, msg: '' })
        : { code: N, messageValues: { param: this.t('permission-id') } }
    },
    getRoleList: async function ({ limit: e = 20, offset: t = 0, needTotal: r = !0 }) {
      const n = { code: 0, msg: '', roleList: (await P.skip(t).limit(e).get()).data }
      if (r) {
        const { total: e } = await P.where({ _id: Jr.exists(!0) }).count()
        n.total = e
      }
      return n
    },
    getRoleInfo: async function (e) {
      const t = await P.where({ role_id: e }).get()
      return 0 === t.data.length ? { code: V } : { code: 0, ...t.data[0] }
    },
    updateRole: async function ({ roleID: e, roleName: t, comment: r, permission: n }) {
      return e
        ? (await P.where({ role_id: e }).update({ role_name: t, comment: r, permission: n }),
          { code: 0, msg: '' })
        : { code: N, messageValues: { param: this.t('role-id') } }
    },
    deleteRole: async function ({ roleID: e }) {
      ...
      return (
        await P.where({ role_id: Jr.in(e) }).remove(),
        await j.where({ role: Jr.elemMatch(Jr.in(e)) }).update({ role: Jr.pullAll(e) }),
        { code: 0, msg: '' }
      )
    },
    getPermissionList: async function ({ limit: e = 20, offset: t = 0, needTotal: r = !0 }) {
      const n = { code: 0, msg: '', permissionList: (await D.skip(t).limit(e).get()).data }
      if (r) {
        const { total: e } = await D.where({ _id: Jr.exists(!0) }).count()
        n.total = e
      }
      return n
    },
    ...
    updatePermission: async function ({ permissionID: e, permissionName: t, comment: r }) {
      return e
        ? (await D.where({ permission_id: e }).update({ permission_name: t, comment: r }),
          { code: 0, msg: '' })
        : { code: N, messageValues: { param: this.t('permission-id') } }
    },
    deletePermission: async function ({ permissionID: e }) {
      ...
      return (
        await D.where({ permission_id: Jr.in(e) }).remove(),
        await P.where({ permission: Jr.elemMatch(Jr.in(e)) }).update({ permission: Jr.pullAll(e) }),
        { code: 0, msg: '' }
      )
    },
    bindAlipay: async function ({ uid: e, code: t, platform: r }) {
      ...
      if (!i) return { code: 60401, messageValues: { account: this.t('alipay-account') } }
      let o = await j.where({ ali_openid: i }).get()
      return (
        (o = this._getCurrentAppUser(o.data)),
        o && o.length > 0
          ? { code: 60402, messageValues: { type: this.t('alipay-account') } }
          : (await j.doc(e).update({ ali_openid: i }), { code: 0, openid: i, msg: '' })
      )
    },
    bindEmail: async function ({ uid: e, email: t, code: r }) {
      if (!(t = t && t.trim())) return { code: N, messageValues: { param: '邮箱' } }
      if (!r) return { code: N, messageValues: { param: '验证码' } }
      const { emailToLowerCase: n } = this._getConfig()
      n && (t = t.toLowerCase())
      let i = await j.where({ email: t, email_confirmed: 1 }).get()
      if (((i = this._getCurrentAppUser(i.data)), i && i.length > 0))
        return { code: 60201, messageValues: { type: '邮箱' } }
      if (r) {
        const e = await this.verifyCode({ email: t, code: r, type: 'bind' })
        if (0 !== e.code) return e
      }
      return await j.doc(e).update({ email: t, email_confirmed: 1 }), { code: 0, msg: '', email: t }
    },
    bindMobile: async function ({
      ...
      if ('univerify' === o) {
        ...
        const o = await zr.bind(this)({ ...r, openid: n, access_token: i })
        if (0 !== o.code) return o
        t = '' + o.phoneNumber
      }
      let s = await j.where({ mobile: t, mobile_confirmed: 1 }).get()
      if (((s = this._getCurrentAppUser(s.data)), s && s.length > 0))
        return { code: 60101, messageValues: { type: '手机号' } }
      if ('sms' === o && r) {
        if (!t) return { code: N, messageValues: { param: this.t('mobile') } }
        if (!r) return { code: N, messageValues: { param: this.t('verify-code') } }
        const e = await this.verifyCode({ mobile: t, code: r, type: 'bind' })
        if (0 !== e.code) return e
      }
      return (
        await j.doc(e).update({ mobile: t, mobile_confirmed: 1 }), { code: 0, msg: '', mobile: t }
      )
    },
    bindWeixin: async function ({ uid: e, code: t, platform: r }) {
      ...
      if (((f = this._getCurrentAppUser(f.data)), f && f.length > 0))
        return { code: 60302, messageValues: { type: this.t('wechat-account') } }
      const h = { wx_openid: { [n]: o } }
      let m
      return (
        s && (h.wx_unionid = s),
        await j.doc(e).update(h),
        (m = i ? { sessionKey: a } : { accessToken: c, refreshToken: u, accessTokenExpired: d }),
        { code: 0, msg: '', openid: o, unionid: s, ...m }
      )
    },
    bindQQ: async function ({ uid: e, code: t, accessToken: r, platform: n } = {}) {
      ...
      if (((l = this._getCurrentAppUser(l.data)), l && l.length > 0))
        return { code: 60502, messageValues: { type: this.t('qq-account') } }
      const p = { qq_openid: { [i]: s } }
      return (
        a && (p.qq_unionid = a),
        await j.doc(e).update(p),
        { code: 0, msg: '', openid: s, unionid: a, ...{ accessToken: r, sessionKey: c } }
      )
    },
    unbindAlipay: async function (e) {
      const t = en.command,
        r = await j.doc(e).update({ ali_openid: t.remove() })
      return C('upRes:', r), 1 === r.updated ? { code: 0, msg: '' } : { code: 70401 }
    },
    unbindEmail: async function ({ uid: e, email: t, code: r }) {
      if (((t = t && t.trim()), !e || !t))
        return { code: N, messageValues: { param: e ? this.t('email') : this.t('user-id') } }
      const { emailToLowerCase: n } = this._getConfig()
      if (r) {
      ...
      return 1 ===
        (await j.where(o).update({ email: i.remove(), email_confirmed: i.remove() })).updated
        ? { code: 0, msg: '' }
        : { code: 70201 }
    },
    ...
    unbindWeixin: async function (e) {
      const t = nn.command,
        r = await j.doc(e).update({ wx_openid: t.remove(), wx_unionid: t.remove() })
      return C('upRes:', r), 1 === r.updated ? { code: 0, msg: '' } : { code: 70301 }
    },
    unbindQQ: async function (e) {
      const t = on.command,
        r = await j.doc(e).update({ qq_openid: t.remove(), qq_unionid: t.remove() })
      return C('upRes:', r), 1 === r.updated ? { code: 0, msg: '' } : { code: 70501 }
    },
    code2SessionAlipay: async function (e) {
      ...
      try {
        ...
        return r.openid
          ? { code: 0, msg: '', ...r }
          : { code: 80701, messageValues: { account: this.t('alipay-account') } }
      } catch (e) {
        return { code: 80702, messageValues: { account: this.t('alipay-account') } }
      }
    },
    code2SessionWeixin: async function (e) {
      ...
      try {
        const e = t.platform || this.context.PLATFORM,
          r = await this._getWeixinApi({ platform: e })[
            'mp-weixin' === e ? 'code2Session' : 'getOauthAccessToken'
          ](t.code)
        return r.openid
          ? { code: 0, msg: '', ...r }
          : { code: 80601, messageValues: { account: '微信openid' } }
      } catch (e) {
    ...
    verifyAppleIdentityToken: async function ({ identityToken: e, platform: t }) {
      const r = t || this.context.PLATFORM,
        { code: n, msg: i } = await Vr({ clientType: r }).verifyIdentityToken(e)
      return 0 !== n ? { code: n, msg: i } : { code: n, msg: '验证通过', ...i }
    },
    wxBizDataCrypt: async function ({ code: e, sessionKey: r, encryptedData: n, iv: i }) {
      if (!n) return { code: N, messageValues: { param: 'encryptedData' } }
      if (!i) return { code: N, messageValues: { param: 'iv' } }
      if (!e && !r) return { code: N, messageValues: { param: 'sessionKey' } }
      const o = this._getWeixinApi()
      if (!r) {
        const t = await o.code2Session(e)
        if (!t.sessionKey) return { code: 80801 }
        r = t.sessionKey
      }
      ...
      try {
        ...
        return console.error(e), { code: 80802 }
      }
      return a.watermark.appid !== o.options.appId ? { code: 80803 } : { code: 0, msg: '', ...a }
    },
    encryptPwd: function (e, { value: r, version: n } = {}) {
      if (!(e = e && e.trim()))
        throw new Error(this.t('param-required', { param: this.t('password') }))
      if (!r) {
        const e = this._getConfig(),
          { passwordSecret: t } = e
        if ('array' === h(t)) {
      ...
      if (!r)
        throw new Error(
          this.t('param-error', { param: 'passwordSecret', reason: 'invalid passwordSecret' })
        )
      const i = t.createHmac('sha1', r.toString('ascii'))
      return i.update(e), { passwordHash: i.digest('hex'), version: n }
    },
    checkToken: async function (e, { needPermission: t, needUserInfo: r = !0 } = {}) {
      const n = this._getConfig(),
        i = this._verifyToken(e)
      if (i.code) return i
      const { uid: o, needPermission: s, role: a, permission: c, exp: u, iat: d, ...l } = i,
        p = a && c
      t = void 0 === t ? s : t
      const f = n.removePermissionAndRoleFromToken || !p || r,
        h =
          (!n.removePermissionAndRoleFromToken && !p) ||
          (n.removePermissionAndRoleFromToken && p) ||
          (n.tokenExpiresThreshold && u - Date.now() / 1e3 < n.tokenExpiresThreshold)
      let m = {}
      if (f || h) {
        const t = await j.doc(o).get()
        if (!t.data || 0 === t.data.length || !t.data[0].token) return { code: 30202 }
        if (((m = t.data[0]), m.status === B)) return { code: 10001 }
        if (m.status === F) return { code: 10006 }
        let r = m.token
        if ((r ? 'string' == typeof r && (r = [r]) : (r = []), -1 === r.indexOf(e)))
          return { code: 30202 }
      }
      const g = { code: 0, uid: o, ...l }
      let y, w
      if (
        (p && ((g.role = a), (g.permission = c)),
        r && (g.userInfo = m),
        ((!p && t) || h) &&
          ((y = g.role = m.role || []),
          (w =
            0 === y.length || y.includes('admin')
              ? (g.permission = [])
              : (g.permission = await this._getPermissionListByRoleList(g.role))),
          t && ((g.role = y), (g.permission = w))),
        h)
      ) {
        let e
        e = n.removePermissionAndRoleFromToken
          ? await this.createToken({ uid: o, needPermission: s })
          : await this.createToken({ uid: o, role: y, permission: w })
        let t = m.token
    ...
    createToken: function ({ uid: e, needPermission: t, role: r, permission: n }) {
      if (!e) return { code: 30101, messageValues: { param: this.t('user-id') } }
    ...
    _verifyToken: function (e) {
      ...
      try {
        ...
        return 'TokenExpiredError' === e.name ? { code: 30203, err: e } : { code: 30204, err: e }
      }
    ...
    _getPermissionListByRoleList: async function (e) {
      ...
      const t = await P.where({ role_id: sn.in(e) }).get(),
        r = []
      return (
        t.data.forEach((e) => {
          Array.prototype.push.apply(r, e.permission)
    ...
    _getClientUaHash: function () {
      const e = t.createHash('md5'),
        r = /MicroMessenger/i.test(this.context.CLIENTUA)
    ...
    _createTokenInternal: function ({ signContent: e, config: t }) {
      if (
        t.tokenExpiresIn &&
        t.tokenExpiresThreshold &&
        t.tokenExpiresIn <= t.tokenExpiresThreshold
      )
        throw new Error(this.t('token-expires-config-warning'))
      return 'object' === h(e) && e.uid
        ? (t.bindTokenToDevice && (e.clientId = this._getClientUaHash()),
          {
            token: Pr(e, t.tokenSecret, { expiresIn: t.tokenExpiresIn }),
            tokenExpired: Date.now() + 1e3 * t.tokenExpiresIn,
          })
        : { code: 30101, messageValues: { param: this.t('user-id') } }
    },
    setVerifyCode: async function ({ mobile: e, email: t, code: r, expiresIn: n, type: i }) {
      ...
      if (e && t)
        return { code: 50102, messageValues: { param: '参数', reason: '手机号和邮箱不可同时存在' } }
      r || (r = T()), n || (n = 180)
      const o = Date.now(),
        s = {
          mobile: e,
      ...
      return C('addRes', await R.add(s)), { code: 0, mobile: e, email: t }
    },
    verifyCode: async function ({ mobile: e, email: t, code: r, type: n }) {
      ...
      if (e && t)
        return { code: 50203, messageValues: { param: '参数', reason: '手机号和邮箱不可同时存在' } }
      const i = an.command,
        o = Date.now(),
      ...
      if ((C('verifyRecord:', a), a && a.data && a.data.length > 0)) {
        const e = a.data[0]
        return C('upRes', await R.doc(e._id).update({ state: 1 })), { code: 0, msg: '验证通过' }
      }
      return { code: 50202, msg: '验证码错误或已失效' }
    },
    sendSmsCode: async function ({ mobile: e, code: t, type: r, templateId: n }) {
      if (!e) return { code: N, messageValues: { param: this.t('mobile') } }
      if ((t || (t = T()), !r))
        return { code: N, messageValues: { param: this.t('verify-code-type') } }
      const i = this._getConfig()
      let o = i && i.service && i.service.sms
      if (!o) throw new Error(this.t('config-param-required', { param: 'service.sms' }))
      o = Object.assign({ codeExpiresIn: 300 }, o)
      const s = ['smsKey', 'smsSecret']
      for (let e = 0, t = s.length; e < t; e++) {
        const t = s[e]
        if (!o[t]) throw new Error(this.t('config-param-required', { param: 'service.sms.' + t }))
      }
    ...
    ;(F.prototype.clear = function () {
      ...
      (F.prototype.set = function (e, t) {
        ...
        return (
          ...
          (r[e] = M && void 0 === t ? '__lodash_hash_undefined__' : t),
          this
        )
      }),
      ...
      (H.prototype.clear = function () {
        ;(this.size = 0), (this.__data__ = { hash: new F(), map: new (V || $)(), string: new F() })
      }),
                  ...
                  ;(d = c),
                    p || f || h
                      ? he(a)
                        ...
                        ? ((l = !1),
                          (d = (function (e, t) {
                            var r = t
                              ? ((n = e.buffer),
                                (i = new n.constructor(n.byteLength)),
                                new I(i).set(new I(n)),
                                i)
                              : e.buffer
                            var n, i
                      ...
                      : (function (e) {
                          ...
                          return 'function' == typeof r && r instanceof r && _.call(r) == T
                        })(c) || fe(c)
                      ? ((d = a),
                        fe(a)
                          ? (d = (function (e) {
                              return (function (e, t, r, n) {
                                ...
                                for (; ++o < s; ) {
                                  ...
                                  void 0 === c && (c = e[a]), i ? X(r, a, c) : Q(r, a, c)
                                }
                                return r
                              })(e, Ee(e))
                            })(a))
                          : (ve(a) && !ye(a)) ||
                            (d = (function (e) {
                              return 'function' != typeof e.constructor || ue(e) ? {} : B(k(e))
                            })(c)))
                      : (l = !1)
                }
                var m
      ...
      Te =
        ...
        oe(function (e, t) {
          var r = -1,
            ...
            o = n > 2 ? t[2] : void 0
          for (
            i = Ce.length > 3 && 'function' == typeof i ? (n--, i) : void 0,
              o &&
                (function (e, t, r) {
                  if (!ve(r)) return !1
                  var n = typeof t
                  return (
                    !!('number' == n ? me(r) && ce(t, r.length) : 'string' == n && (t in r)) &&
                    pe(r[t], e)
                  )
                })(t[0], t[1], o) &&
                ((i = n < 3 ? void 0 : i), (n = 1)),
...
class ln {
  constructor({ context: e, clientInfo: t, config: r } = {}) {
    const n = dn({ pluginId: 'uni-id' })
    ;(this.pluginConfig = n),
      (this.config = r || this._getConfigContent()),
      (this._configCache = {}),
      Object.defineProperty(this, 'context', {
        get() {
          ...
          for (let e = 0; e < n.length; e++) {
            const t = n[e]
            void 0 === r[t] && console.warn(i.t('context-required', { key: t }))
          }
          const o = r.APPID,
            s = r.PLATFORM
          if ('app' === s || 'app-plus' === s) {
            ...
            if (('app' === r.PLATFORM && e['app-plus']) || ('app-plus' === r.PLATFORM && e.app))
              throw new Error(
                `Client platform is ${r.PLATFORM}, but ${
                  'app' === r.PLATFORM ? 'app-plus' : 'app'
                } was found in config. Please refer to: https://uniapp.dcloud.net.cn/uniCloud/uni-id?id=prefered-app-platform`
              )
          }
          return r
        },
      ...
      n &&
        n.hasFile('custom-token.js') &&
        this.setInterceptor('customToken', require(n.resolve('custom-token.js')))
    let i,
      o = O
    ...
    ;(i = uniCloud.initI18n({ locale: 'en', fallbackLocale: 'zh-Hans', messages: o })),
  ...
  get dev() {
    return console.warn(this.t('dev-warning')), { getConfig: this._getConfig.bind(this) }
  }
  _getAppConfig(e, t) {
    return Array.isArray(e)
      ? e.find((e) => e.dcloudAppid === t) || e.find((e) => e.isDefaultConfig)
      : e
  }
  _getConfigContent() {
  ...
  _getConfig({ appid: e, platform: t } = {}) {
    ...
    return (
      [
        ...
        if (!o || !o[e]) throw new Error(this.t('config-param-required', { param: e }))
      }),
      (this._configCache[r] = o),
      o
    )
  }
}
for (const e in cn) ln.prototype[e] = cn[e]
function pn({ context: e, config: t } = {}) {
  const r = new ln({ context: e, config: t })
  return new Proxy(r, {
    get(e, t) {
