...
var c = a(function (e, t) {
    !(function (n) {
      ...
      function i(e) {
        ...
        return (
          /classCallCheck\(/.test(t) || /TypeError\("Cannot call a class as a function"\)/.test(t)
        )
      }
  ...
  u =
    ...
    a(function (e) {
      ...
      e.exports = function (n = './', ...r) {
        ...
        return (
          i.set(a, {
            path: s.default.isAbsolute(n)
              ? s.default.join(n, './')
              : s.default.join(s.default.dirname(e.parent.filename), n, './'),
            is_class: !1,
          }),
          (function e(n) {
            return new Proxy(n, {
              get: (n, s) => {
                ...
                if (a.is_class)
                  return (
                    a.instance || (a.instance = new n(...r)),
                    a.instance[s] ? a.instance[s] : '$map' == s ? a : a.instance[s]
                  )
                if ('$map' == s) return a
                let u = {}
                const f = a.path + s + '/',
                ...
                if (
                  (t[f] ||
                    (((e) => o.default.existsSync(e) && o.default.statSync(e).isFile())(l)
                      ? (t[f] = 'file')
                      : ((e) => o.default.existsSync(e) && o.default.statSync(e).isDirectory())(f)
                      ? (t[f] = 'dir')
                      : (t[f] = 'none')),
                  'file' == t[f])
                )
              ...
              set: (e, t, n) => {
                ...
                const o = i.get(e)
                return o.is_class
                  ? (o.instance || (o.instance = new e(...r)), (o.instance[t] = n), !0)
                  : ((e[t] = n), !0)
              },
            })
          })(a)
...
function A(e, t) {
  if (t) {
    const { headers: t, httpMethod: n, body: i, queryStringParameters: o } = e.event
    if (
      ((function (e) {
        const t = Object.keys(e).find((e) => 'content-type' === e.toLowerCase())
        t
          ? ((e['content-type'] = e[t].toLowerCase()), 'content-type' !== t && delete e[t])
          : (e['content-type'] = C)
      })(t),
      (e.query = o),
      'GET' === n)
      ...
      else 'application/x-www-form-urlencoded' === n && (e.data = r.parse(i))
    }
  }
  e.set = function (t, n) {
    if (2 === arguments.length)
      Array.isArray(n)
        ? (n = n.map((e) => ('string' == typeof e ? e : String(e))))
        : 'string' != typeof n && (n = String(n)),
        (e.headers[t] = n)
    else if (b(t)) for (const n in t) e.set(n, t[n])
  }
}
async function R(e, t) {
  ...
  if ((A(e, n), n)) {
    ...
    try {
      ...
      return (
        !0 === e.config.debug && (r.stack = t.stack || ''),
        (e.body = {
...
class S extends n.EventEmitter {
  constructor(e) {
    ...
    const { baseDir: t = process.cwd(), middleware: n } = this.config
    ;(this.serviceDir = s.default.resolve(t, 'service')),
      (this.controllerDir = s.default.resolve(t, 'controller')),
      this.initMiddleware(n)
  }
  use(e, t) {
  ...
  async serve(e, t) {
    const n = (function (e, t, n, r, i) {
        ...
        return (
          ...
          (o.service = u(r, o)),
          (o.controller = u(i, o)),
          (o.query = Object.create(null)),
          (o.data = t.data || Object.create(null)),
          (o.status = 200),
          ...
          m &&
            ((o.db = uniCloud.database()),
            (o.curl = uniCloud.httpclient.request.bind(uniCloud.httpclient)),
            (o.httpclient = uniCloud.httpclient)),
          o
        )
      })(
        this.config,
    ...
    let i
    return (
      (i = 'error' === r._name ? E([R, r]) : E(this.middleware.concat(r))),
      new Promise((e) => {
        i(n)
          .then(() => {
            e(this.respond(n))
  ...
  wrapMiddleware(e, t) {
    const n = (function (e) {
        if (!e) return g
        const { enable: t, match: n, ignore: r } = e
        if (!1 === t) return v
        if (!n && !r) return g
  ...
  controller(e) {
    ...
    if ('function' != typeof s)
      return O(`controller/${t.replace(new RegExp('/' + i + '$'), '.' + i)} is not a function`)
