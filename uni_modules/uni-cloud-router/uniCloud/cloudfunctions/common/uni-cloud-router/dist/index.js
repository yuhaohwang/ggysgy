	...
	u = (c.isClass, a((function(e) {
		...
		e.exports = function(n = "./", ...r) {
			const i = new Map,
				a = {};
			return i.set(a, {
					path: s.default.isAbsolute(n) ? s.default.join(n, "./") : s.default.join(s
						.default.dirname(e.parent.filename), n, "./"),
					is_class: !1
				}),
				function e(n) {
					return new Proxy(n, {
						get: (n, s) => {
							if (s in n || "symbol" == typeof s || "inspect" == s) return n[
								s];
							const a = i.get(n);
							if (a.is_class) return a.instance || (a.instance = new n(...r)),
								a.instance[s] ? a.instance[s] : "$map" == s ? a : a
								.instance[s];
							if ("$map" == s) return a;
							let u = {};
							const f = a.path + s + "/",
								l = a.path + s + ".js";
							if (t[f] || ((e => o.default.existsSync(e) && o.default
									.statSync(e).isFile())(l) ? t[f] = "file" : (e => o
									.default.existsSync(e) && o.default.statSync(e)
									.isDirectory())(f) ? t[f] = "dir" : t[f] = "none"),
								"file" == t[f]) u = require(l);
						...
						set: (e, t, n) => {
							...
							const o = i.get(e);
							return o.is_class ? (o.instance || (o.instance = new e(...r)), o
...
function f(e, t) {
	...
	for (var n = function(e) {
								...
								if ("}" !== r)
									if (":" !== r)
										if ("(" !== r) t.push({
											...
											var i = 1,
												o = "";
											if ("?" === e[a = n + 1]) throw new TypeError(
			...
			}(e), r = t.prefixes, i = void 0 === r ? "./" : r, o = "[^" + l(t.delimiter || "/#?") + "]+?", s = [], a =
			0, c = 0, u = "", f = function(e) {
...
function p(e, t, n) {
	return function(e, t, n) {
		void 0 === n && (n = {});
		for (var r = n.strict, i = void 0 !== r && r, o = n.start, s = void 0 === o || o, a = n.end, c = void 0 ===
				a || a, u = n.encode, f = void 0 === u ? function(e) {
					return e
				} : u, p = "[" + l(n.endsWith || "") + "]|$", h = "[" + l(n.delimiter || "/#?") + "]", y = s ? "^" :
				"", m = 0, v = e; m < v.length; m++) {
			var g = v[m];
...
class S extends n.EventEmitter {
	...
	async serve(e, t) {
		const n = function(e, t, n, r, i) {
				...
				return o.config = e, o.service = u(r, o), o.controller = u(i, o), o.query = Object.create(null),
					o.data = t.data || Object.create(null), o.status = 200, o.headers = Object.create(null), o
					.throw = (e, t) => {
						if (t) throw {
							code: e,
							message: t
					...
					}, m && (o.db = uniCloud.database(), o.curl = uniCloud.httpclient.request.bind(uniCloud
						.httpclient), o.httpclient = uniCloud.httpclient), o
			}(this.config, e || m && uniCloud.$args, t || m && uniCloud.$ctx, this.serviceDir, this
				.controllerDir),
			r = this.controller(n);
		let i;
	...
	controller(e) {
		...
		const s = o[i];
		if ("function" != typeof s) return O(
			`controller/${t.replace(new RegExp("/"+i+"$"),"."+i)} is not a function`);
