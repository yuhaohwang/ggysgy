...
module.exports = class OrderController extends Controller {
  ...
  async create() {
    ...
    const { cart_ids, goods_id, goods_num, goods_sku_id, addr_id, order_from, order_desc } =
      this.ctx.data
  ...
  async evaluate() {
    ...
    const start = new Date().getTime()
    const { order_id, review_cnt, review_imgs, review_type, review_content, review_anontmity } =
      this.ctx.data
