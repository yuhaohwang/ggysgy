<template>
  <view>
    ...
    <view
      ...
      style="top: 30rpx; right: 30rpx; opacity: 0.6; background: #333; width: 80rpx; height: 80rpx"
      @click="toShare"
    >
    ...
    <view class="goods-area bg-main padding">
      ...
      >
      <view class="">
        一套 js 解决前端、后端、数据库的全栈开发 serverless 模式（小程序、h5、app、vue + element-ui
        + uniCloud 版管理后台）前后端开源 QQ群 1020565856
      </view>
    </view>
    <!-- 07. 操作区 -->
    <view class="oper-area pos-f dflex-b w-full padding-lr-lg">
      <view class="dflex">
        ...
        <view class="btn-area dflex-c" :class="{ active: favorite }">
          <text
            class="iconfont iconshoucang-01"
