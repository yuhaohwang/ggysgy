      ...
      >
        ...
        <view class="order-item padding bg-main border-radius">
          <view @click="todetail(item.order)">
            ...
            >
              ...
              <view class="right flex1">
                <text class="clamp-2"
                  >{{ goodsItem.goods_name }} {{ goodsItem.goods_name_pw }}</text
                >
          ...
          <view class="dflex-b margin-top-sm">
            <view>
              <!-- 当前状态 -->
              <text class="ft-dark" v-if="item.order.order_refund_state == '处理中'"
                >退款处理中</text
              >
            ...
            <view class="dflex-e">
              <view class="dflex" v-if="item.order.state == '待付款'">
                <button class="action-btn border-radius-big bg-main" @click="cancelOrder(item)"
                  >取消订单</button
                >
