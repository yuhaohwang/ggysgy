  ...
  <view class="content bg-drak ft-main">
    ...
    <view class="row dflex border-line padding-left">
      ...
      <view class="dflex-b flex1">
        ...
        <view
          class="iconfont icondizhi- input_t padding-lr-sm padding-tb-16"
          @click="choiceMapAddr"
        ></view>
        <!-- #endif -->
        <!-- #ifdef MP-ALIPAY -->
      ...
      if (options.type === 'edit') {
        ...
        this.$db[__name].tofirst(this.id).then((res) => {
          if (res.code == 200) {
            ...
            this.addressName =
              this.addrData.province_name +
              '-' +
              this.addrData.city_name +
              '-' +
