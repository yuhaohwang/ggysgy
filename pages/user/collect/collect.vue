<template>
  <view class="bg-drak" :class="[empty ? '' : 'padding-tb']">
    ...
    <view v-else class="padding-lr" v-for="(item, index) in datas" :key="index">
      <view
        class="product border-radius-sm padding margin-bottom-sm bg-main"
        ...
        <view class="margin-left-sm pos-r w-full">
          ...
          <view class="pos-a dflex-b price-box w-full">
            ...
            <view class="dflex-c ft-dark">
              <button
                class="btn no-border padding-0 fs-sm ft-dark"
                open-type="share"
                :id="item.goods_id"
              >
              ...
              <view
                @tap.stop="deleteCollect(item._id)"
                class="dflex-c margin-left-sm padding-tb-sm"
              >
