...
<script>
	...
	export default {
		...
		methods: {
			login() {
				uni.navigateTo({
					url: '/pages/uni-id-pages/login/login-withoutpwd',
					complete: (e) => {
						console.log(e);
					}
				})
			...
			changePassword(){
				uni.navigateTo({
					url: '/pages/uni-id-pages/userinfo/change_pwd/change_pwd',
					complete: (e) => {
						console.log(e);
					}
				})
			...
			deactivate(){
				uni.navigateTo({
					url:"/pages/uni-id-pages/userinfo/deactivate/deactivate"
				})
			}
		}
	}
...
<style lang="scss" scoped>
	@import url("/common/login-page.scss");
