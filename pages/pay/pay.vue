	...
	<view class="app w-full">
		...
		<view class="pay-type-list">
			...
			<view class="type-item dflex-b pos-r padding-tb-sm" @click="changePayType('头条支付', '微信支付', 'MWEB')">
				...
				<label class="radio">
					<radio value="wxpay" color="#feaa30" colors="#feaa30" :checked="pay_way == '头条支付' && pay_trade_type == 'MWEB'"
					 :disabled="money <= 0" />
					</radio>
				</label>
			</view>
			...
			<view class="type-item dflex-b pos-r padding-tb-sm" @click="changePayType('微信支付', '微信支付', 'NATIVE')">
				...
				<label class="radio">
					<radio value="wxpay" color="#feaa30" colors="#feaa30" :checked="pay_way == '微信支付' && pay_trade_type == 'NATIVE'" :disabled="money <= 0" /></radio>
				</label>
			</view>
